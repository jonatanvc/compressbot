...
async def upsert_progress(
    ...
    line3 = f"<b><i>Processing:</i></b> <code>{display_percent:.2f}%</code>"
    ...
    line_details = (
        f"<b><i>Details:</i></b> <code>{details_html}</code>"
        if details_html
        else "<b><i>Details:</i></b> <code>--</code>"
    )
    ...
    if uses_byte_progress:
        ...
        line4 = f"<b><i>Data:</i></b> <code>{_format_iec_bytes(byte_current)} of {_format_iec_bytes(byte_total)}</code>"
        line5 = f"<b><i>Speed:</i></b> <code>{_format_iec_bytes(max(0, speed_bps))}/s</code>"
    else:
        line4 = "<b><i>Data:</i></b> <code>calculating...</code>"
        line5 = "<b><i>Speed:</i></b> <code>0 B/s</code>"

    line6 = f"<b><i>ETA:</i></b> <code>{html_escape(eta_text)}</code>"
