...
async def _retry_async_inner(
    ...
    for attempt in range(1, cfg.max_retries + 1):
        ...
        try:
            ...
            # CancelledError del task padre (cancel_active_task): cancelar también
            # el task hijo para que no quede subiendo en segundo plano.
            if not task.done():
                task.cancel()
            raise
...
async def upsert_progress(
    ...
    if uses_byte_progress:
        ...
        line4 = "<b>Data:</b> <code>--</code>"
        line5 = "<b>Speed:</b> <code>--</code>"
...
async def send_path_with_size_control(
    ...
    single_upload_limit = int(cfg.single_upload_max_bytes)
