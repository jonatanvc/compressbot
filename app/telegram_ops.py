...
async def upsert_progress(
    ...
    eta_text = _format_duration(eta_seconds) if eta_seconds is not None else "calculating..."
    ...
    if pulse and bounded_current == 0 and total_safe > 1 and percent < 100.0:
    ...
    if uses_byte_progress:
        ...
        elif elapsed > 0.1 and bounded_current > 0:
        ...
        line4 = f"{bounded_current} of {total_safe} items"
        line5 = "Speed : n/a"
