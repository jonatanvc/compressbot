...
# Techo para subida directa (sin dividir). Archivos mayores siempre se dividen
# en partes para: (a) progreso visible entre partes, (b) timeouts cortos por parte,
# (c) detección rapida de stalls, (d) menos RAM por request HTTP.
MAX_DIRECT_UPLOAD_BYTES = 512 * 1024 * 1024
