...
def compressed_result_keyboard(action_id: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(BTN_ENCRYPTAR, callback_data=f"{CB_ENCRYPTAR}:{action_id}"),
                InlineKeyboardButton(BTN_RENOMBRAR, callback_data=f"{CB_RENOMBRAR}:{action_id}"),
            ],
            [InlineKeyboardButton(BTN_LISTO, callback_data=f"{CB_LISTO}:{action_id}")],
        ]
    )
