...
class BotHandlers:
    ...
    async def process_extract_queue(self, update: Update, context: ContextTypes.DEFAULT_TYPE, password: str | None = None) -> bool:
        ...
        output_root = workspace / "extract_output"
        # Limpiar inbox antes de cada sesión para evitar acumular archives de
        # sesiones anteriores: Windows AV escanea el directorio completo al
        # escribir nuevos archives, causando degradación severa de velocidad.
        shutil.rmtree(inbox, ignore_errors=True)
