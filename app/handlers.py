        ...
        async with user_lock:
            ...
            try:
                ...
                for part_index, part in enumerate(output_parts, start=1):
                    ...
                    # o fallos de red/timeout antes de abortar.
                    for attempt in range(3):
                        ...
                        try:
                            ...
                            self._raise_if_cancel_requested(context)
                            await asyncio.sleep(min(2.0, self.cfg.retry_base_delay * (2 ** attempt)))
                    else:
                        raise RuntimeError(f"No se pudo subir la parte {part.name} tras multiples intentos")
