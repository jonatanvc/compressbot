        ...
        try:
            ...
            if proc.returncode != 0:
                ...
                if "errno=2" in detail_lower or "no such file or directory" in detail_lower:
                    ...
                    wrap_proc = subprocess.run(wrap_cmd, cwd=str(source_zip.parent), capture_output=True, text=True)
                    if wrap_proc.returncode == 0:
                        return
                    wrap_detail = (wrap_proc.stderr or wrap_proc.stdout or "").strip()
