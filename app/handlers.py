...
from .telegram_ops import format_bot_text, retry_async_with_cancel, send_path_with_size_control, tracked_reply, upsert_progress
        ...
        async with user_lock:
            ...
            try:
                        ...
                        with archive_path.open("rb") as archive_file:
                            return await asyncio.wait_for(
                                context.bot.send_document(
                                    ...
                                    read_timeout=single_timeout,
                                    write_timeout=single_timeout,
                                ),
                ...
                if should_fallback_to_split:
                    ...
                    all_fallback_sizes = [
                        recommended_part,
                        min(256 * 1024 * 1024, recommended_part),
                        128 * 1024 * 1024,
                    ]
                                    ...
                                    with part.open("rb") as archive_file:
                                        return await asyncio.wait_for(
                                            context.bot.send_document(
                                                ...
                                                read_timeout=part_timeout,
                                                write_timeout=part_timeout,
                                            ),
