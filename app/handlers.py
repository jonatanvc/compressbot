...
class BotHandlers:
    ...
    async def _extract_local_targets(
        ...
        for index, local_archive in enumerate(targets, start=1):
            ...
            # .7z.001, .zip.001, .rar.001 → 7z/extract_archive maneja nativamente
            # sin necesidad de rejoin manual
