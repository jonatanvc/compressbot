        ...
        async with user_lock:
            ...
            try:
                ...
                def _is_too_large_error(exc: Exception) -> bool:
                    text = str(exc).lower()
                    return any(token in text for token in ("file is too big", "entity too large", "request entity too large", "file too large"))
                ...
                while True:
                    output_parts = await asyncio.to_thread(
                        ...
                        1900 * 1024 * 1024 if fallback_used else None,
                    )
                    ...
                    try:
                        ...
                        if not fallback_used and _is_too_large_error(exc):
                            fallback_used = True
                            continue
                        raise
