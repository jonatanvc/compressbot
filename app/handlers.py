...
class BotHandlers:
    ...
    def _recommended_upload_part_size(size_bytes: int, base_part_size: int) -> int:
        ...
        if size_bytes >= 1536 * 1024 * 1024:
            return min(base_part_size, 512 * 1024 * 1024)
        if size_bytes >= 768 * 1024 * 1024:
            return min(base_part_size, 768 * 1024 * 1024)
    ...
    async def _extract_local_targets(
        ...
        for index, local_archive in enumerate(targets, start=1):
            ...
            # Lista plana: si dentro hay ZIPs, se envian como archivos normales,
            # sin intentar descomprimirlos.
